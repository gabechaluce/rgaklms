...
$project_cost = isset($project['project_cost']) ? $project['project_cost'] : '';
    ...
    $estimators = $conn->query("SELECT *, CONCAT(firstname, ' ', lastname) AS name FROM users WHERE type = '6' AND id IN ($user_ids)");
...
if (!empty($coordinator_ids)) {
    ...
    // Only allow when project is NOT in "To be reviewed" status (status != 1) or user is an admin
    ...
    // Add this function at the beginning of your code to check if a user has task permissions
    function userCanManageTasks($user_type) {
        ...
        // 14: Project Manager
        $allowed_roles = array(1, 2, 4, 8, 14);
...
<dl>
    ...
    <dd>
        ...
        <!-- Modified code: Team Members and Task List in a row -->
        <div class="row">
            <!-- Original Team Member section code -->
            <div class="col-md-4">
...
?>
            ...
            <!-- Task List section moved to be side-by-side with Team Members -->
...
<?php endif; ?>
        ...
        <!-- Accept/Decline Actions for Project Coordinators -->
    ...
    <script>
        ...
        // Project status update for project coordinators
...
// In your project_details.php script section
$('.delete-file-btn').click(function(){
    ...
    <style>/* Add this CSS to your project's stylesheet or add it directly to project_details.php */
    ...
    /* If you're using Font Awesome 5 */
    .file-attachment i {
        width: 20px;
        text-align: center;
        margin-right: 5px;
    ...
    .edit-project-btn .btn {
        ...
        color: white !important; /* This ensures text is always white */
    }
    </style>
    </body>
    </html>