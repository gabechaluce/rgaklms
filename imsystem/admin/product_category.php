...
<div class="wrapper">
  ...
  <div class="pull-right">
    <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addnew"><i class="fa fa-plus"></i> Add New Category</button>
  </div>
</div>
            <div class="box-body">
  ...
  <?php include 'includes/product_category_modal.php'; ?>
...
function getRow(id){
  $.ajax({
    type: 'POST',
    url: 'product_category_row.php',
    data: {id:id},
    dataType: 'json',
    success: function(response){
      $('.catid').val(response.id);
      $('#edit_inventory_selection').val(response.inventory_selection);
      $('#edit_name').val(response.company_name);
      $('#del_cat').html(response.company_name);
      $('#del_inventory').html(response.inventory_selection);
    }
  });
}
</script>
