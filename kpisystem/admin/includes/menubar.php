<aside class="main-sidebar">
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="header">KPI Management</li>
      <li><a href="home.php"><i class="fas fa-tachometer-alt"></i> <span>&nbsp;KPI Dashboard</span></a></li>
      

      <li><a href="evaluation.php"><i class="fa fa-check nav-icon"></i> <span>&nbsp;Evaluation</span></a></li>
       <li><a href="evaluationList.php"><i class="fa fa-list nav-icon"></i> <span>&nbsp;Evaluation List</span></a></li>
      
      <li><a href="scoringGuide.php"><i class="fa fa-star nav-icon"></i> <span>&nbsp;Scoring Guide</span></a></li>
      <li><a href="scoringWeight.php"><i class="fa fa-balance-scale"></i> <span>&nbsp;Weight</span></a></li>
      <li><a href="kpiDetails.php"><i class="fa fa-chart-line"></i> <span>&nbsp;KPI Details</span></a></li>
...
<style>
  ...
  /* Special styling for KPI roles submenu */
  #kpi-roles-treeview .treeview-menu {
    border-left: 2px solid rgba(255, 255, 255, 0.3);
    margin-left: 10px;
  }
  
  /* Special styling for position submenu */
  #positions-treeview .treeview-menu {
    border-left: 2px solid rgba(255, 255, 255, 0.3);
    margin-left: 10px;
  }
</style>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  setTimeout(function() {
    ...
    // Add handlers for each treeview menu by ID (including the new kpi-roles-treeview)
    $('#reports-treeview > a, #cartrack-treeview > a, #kpi-roles-treeview > a, #positions-treeview > a, #transaction-treeview > a, #equipment-treeview > a').on('click', function(e) {
